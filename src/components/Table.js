        ...
        <table className="table-fixed w-full text-sm text-left text-gray-200">
          <thead className="text-xs uppercase text-white border-b border-t border-gray-700">
            <tr className="text-right">
              ...
              <th className="text-left p-4 w-36 md:w-44 lg:w-64 sticky left-10 bg-neutral-900 z-10">Coin</th>
              <th className="w-28 p-4 sticky top-0">Price</th>
              <th className="w-20 p-4">24h</th>
              <th className="w-20 p-4">24h %</th>
              <th className="w-28 p-4">24 High</th>
              <th className="w-24 p-4">24 Low</th>
              ...
              <th className="w-48 p-4">Last Updated</th>
            </tr>
          </thead>
          <tbody>
            {props.coins.map(item => (
              <tr key={item.id} className="h-16 border-gray-700 hover:!bg-neutral-800 border-b text-right">
                ...
                {console.log(item.price_change_24h)}
                ...
                <td className="p-4 text-right">{formatDateAndTime(item.last_updated)}</td>
              </tr>
            ))}
          </tbody>
        </table>
